...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  console.log(quotes)
  //create html quote cards ให้ create DOM เเล้วเก็บมันเป็นลูกใต้ All Quotes
...
function newQuoteCard(quote) {
  ...
  editButtonEle.addEventListener("click", handleEdit) //เพิ่มบรรทัดนี่
  ...
  deleteButtonEle.addEventListener("click", handleDelete) //เพิ่มบรรทัดนี่
